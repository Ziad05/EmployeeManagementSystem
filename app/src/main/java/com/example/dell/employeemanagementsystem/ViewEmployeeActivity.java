...
public class ViewEmployeeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextId=(EditText)findViewById(R.id.editTextupdateId);
        editTextName=(EditText)findViewById(R.id.editTextupdateName);
        editTextDesignation=(EditText)findViewById(R.id.editTextupdateDesg);
        editTextSalary=(EditText)findViewById(R.id.editTextupdateSalary);
    ...
    private void getEmployee(){
        ...
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                loading = ProgressDialog.show(ViewEmployeeActivity.this, "Fetching Data", "Wait",false,false);
            }
            @Override
    ...
    private void showEmployee(String json) {
        try {
            ...
            editTextDesignation.setText(desg);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(ViewEmployeeActivity.this,ViewAllItemActivity.class));
                    }
                });
